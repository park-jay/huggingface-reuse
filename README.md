...
The code for this research question is available in the [RQ1 file](https://github.com/park-jay/huggingface-reuse/blob/main/rq1.ipynb)

## RQ 2: To what extent do lineage depths vary across model families? (Lineage depth analysis)
The code for this research question is available in the [RQ2 file](https://github.com/park-jay/huggingface-reuse/blob/main/rq2.ipynb)
